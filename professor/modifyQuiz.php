...
if (!isset($_POST['submit'])) {
	...
	if (isset($_POST['quiztitle']) && isset($_POST['quizdescription']) && isset($_POST['availabletime'])  && isset($_POST['enddate']) && isset($_POST['timelimit']) ) {
		if($_POST['quiztitle']!='' && $_POST['quizdescription']!='' && $_POST['availabletime']!='' && $_POST['enddate']!='' && $_POST['timelimit']!=''){
			...
			$quizdescription = ($_POST['quizdescription']);
					...
					$db->updateQuiz($id,$quiztitle,$quizdescription,$availabletime,$enddate,$timelimit);
