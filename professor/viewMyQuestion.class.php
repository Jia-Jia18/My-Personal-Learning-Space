...
class viewMyQuestion
{
	...
	public function takeQuiz($count)
	{
		...
		$questionNumber
			<br> {$this->question} </br>
			<blockquote>
			<input type='radio' name=$answerNum value='A'>{$this->selectionA}<br>
			<input type='radio' name=$answerNum value='B'>{$this->selectionB}<br>
			<input type='radio' name=$answerNum value='C'>{$this->selectionC}<br>
			<input type='radio' name=$answerNum value='D'>{$this->selectionD}<br>
